...
between RefSeq and Ensembl annotation sets in ANNOVAR [@McCarthy2014], and tools without
...
widely used in research genomics, are absent from UTA entirely. PyHGVS additionally
lacks alignment gap support, causing incorrect coordinate conversion for transcripts
with indels relative to the reference genome.
